...
export default function Transactions() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Summary bar — inline row */}
      <div className="grid grid-cols-3 gap-2">
        <div className="glass-card-green rounded-2xl px-3 py-3 flex flex-col items-center gap-1.5">
        ...
        <div className="glass-card-red rounded-2xl px-3 py-3 flex flex-col items-center gap-1.5">
          <div className="h-8 w-8 rounded-full bg-action-red/10 flex items-center justify-center">
        ...
        <div className={`${totalLent - totalBorrowed >= 0 ? 'glass-card-green' : 'glass-card-red'} rounded-2xl px-3 py-3 flex flex-col items-center gap-1.5`}>
          <div className={`h-8 w-8 rounded-full flex items-center justify-center ${totalLent - totalBorrowed >= 0 ? 'bg-success/10' : 'bg-action-red/10'}`}>
